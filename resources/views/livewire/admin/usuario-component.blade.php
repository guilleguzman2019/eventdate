<div>
    ...
    <h1 class="fs-21 fw-700 mb-1">Usuarios</h1>
    <h2 class="fs-14 text-muted mb-5">Creación, edición y eliminación de Usuarios</h2>
    ...
    <div class="row gx-sm-5">
        <div class="col-sm-5">
            <div class="p-4 border-dashed rounded-4 position-relative">
                ...
                <h3 class="fs-18 mb-3">Crear Usuarios</h3>
                ...
                <div class="row">
                    <div class="col-sm-4">
						<div class="mb-3">
							<label class="fs-14 fw-400 mb-1">rol</label>
							<select class="form-select  py-2 rounded-3 text-muted fs-14" wire:model.defer="createArray.role">
