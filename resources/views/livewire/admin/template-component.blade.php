<div>
    ...
    <h1 class="fs-21 fw-700 mb-1">Templates</h1>
    <h2 class="fs-14 text-muted mb-5">Creación, edición y eliminación de templates</h2>
    ...
    <div class="row gx-sm-5">
        <div class="col-sm-5">
            <div class="p-4 border-dashed rounded-4 position-relative">
                ...
                <h3 class="fs-18 mb-3">Crear templates</h3>
                ...
                <div class="">
                    <div class="bg-secondary bg-opacity-10 px-4 py-2 rounded-4">
                        ...
                        <input class="border-0 bg-transparent w-100" type="text" wire:model.defer="createArray.name" autofocus placeholder="Nombre del template" />
                    </div>
				...
				<div class="row">
                    <div class="col-sm-4">
						<div class="mb-3">
							...
							<select class="form-select  py-2 rounded-3 text-muted fs-14" wire:model.defer="category_id">
