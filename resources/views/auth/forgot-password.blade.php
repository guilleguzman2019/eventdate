<x-guest-layout>
	<form method="POST" action="{{ route('password.email') }}" class="mt-5 pt-5">
		...
		<span class="text-uppercase fs-14 text-muted fw-600 mb-4 d-block">{{ __('Forgot your password?') }}</span>
		<h1 class="fs-48 fs-xs-36 fw-600 mb-4">Recuperar contraseña<span class="text-primary">.</span></h1>
		...
		<button class="btn btn-primary px-5 rounded-4 py-3 fs-18">{{ __('Email Password Reset Link') }}</button>
	</form>
</x-guest-layout>
