			...
			<div class="owl-carousel" wire:ignore.self>
				...
				<div class="item card p-4 two" >
					...
					<div class="card-body text-center">
                      <input wire:models="events[{{ $index }}]['title']" class="card-title" type="text" value="">
					  <input wire:models="events.{{ $index }}.place_name" class="card-lugar" value="">
					  <input wire:models="events.{{ $index }}.address" class="card-text" value="">
					  <br>
					  <br>
