    ...
    <div class="container-fluid p-4" id="boton_cont" style="position:fixed; width: 100%; z-index: 99999999999;">
        <div class="row">
          ...
          <div class="col align-self-end" style="text-align: end; display:none;" id="addEvent">
			<a class="botonhashtag" href="#openModal">AGREGAR EVENTO</a>
          </div>
...
<main>
	<div class="view hm-black-light" style="background-image: url('{{ asset( $card -> home_bg_desktop )}}')">
				...
				<div class="row align-items-center">
					...
					<div class="col-1">
						...
						<div id="my-button">
							...
							<input wire:model="image" id="file-upload" type="file" style="display: none" onchange="uploadFile(this.files)" />
						</div>
		...
		<div class="col-md-12 text-center">
		  <div class="carousel-wrap" wire:ignore.self>
			<div class="owl-carousel" wire:ignore.self>
				...
				<div class="card p-4 two">
					<button class="btn btn-danger">Eliminar</button>
					<br>
					<img class="card-img-top" src="{{asset( $event -> image )}}" alt="Card image cap" height="450px" width="150px">
					<div class="card-body">
