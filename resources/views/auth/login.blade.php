<x-guest-layout>
	<form method="POST" action="{{ route('login') }}" class="mt-5 pt-5">
		...
		<h1 class="fs-48 fs-xs-36 fw-600 mb-4">Iniciar sesión<span class="text-primary">.</span></h1>
		...
		<div class="row">
			<div class="col-sm-3">
				...
				<div class="d-sm-flex justify-content-between mb-4 fs-14">
		...
		<button class="btn btn-primary px-5 rounded-4 py-3 fs-18">{{ __('Log in') }}</button>
	</form>
</x-guest-layout>
