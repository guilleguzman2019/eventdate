<div>
    ...
    <h1 class="fs-21 fw-700 mb-1">Clientes</h1>
    <h2 class="fs-14 text-muted mb-5">Creación, edición y eliminación de clientes</h2>
    ...
    <div class="row gx-sm-5">
        <div class="col-sm-5">
            <div class="p-4 border-dashed rounded-4 position-relative">
                ...
                <h3 class="fs-18 mb-3">Crear Cliente</h3>
                ...
                <div class="">
                    <div class="bg-secondary bg-opacity-10 px-4 py-2 rounded-4">
                        ...
                        <input class="border-0 bg-transparent w-100" type="text" wire:model.defer="createArray.name" autofocus placeholder="Nombre" />
                    </div>
                ...
                <div class="">
                    <div class="bg-secondary bg-opacity-10 px-4 py-2 rounded-4">
                        ...
                        <input class="border-0 bg-transparent w-100" type="text" wire:model.defer="createArray.email" autofocus placeholder="Email" />
                    </div>
                ...
                <div class="">
                    <div class="bg-secondary bg-opacity-10 px-4 py-2 rounded-4">
                        ...
                        <input class="border-0 bg-transparent w-100" type="text" wire:model.defer="createArray.password" autofocus placeholder="Password" />
                    </div>

                    @error('createArray.password')
                        <span class="fs-12 text-danger">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="row">
                    <div class="col-sm-4">
                        {{--<div class="mb-3">
                            <label class="fs-14 d-block mb-2">Imagen Perfil<span class="text-danger fs-16">*</span></label>
        ...
        <div class="col-sm-7">
                            ...
                            <tr class="border-bottom-dashed align-middle">
                                <td class="ps-0 py-3">
                                    <div class="d-flex align-items-center">
                                        <div class="ratio ratio-1x1 rounded-3 bg-img me-3" style="background-image: url({{ asset($cliente -> image) }}); width: 40px;"></div>
                                        <span class="fs-16 fw-700">{{ $cliente -> name }}</span>
                                    </div>
                                </td>
                                <td>
                                    <span class="fs-16 fw-700">{{ $cliente -> email }}</span>
								</td>
                                <td class="text-end pe-0">
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end">
                                          <li><a class="dropdown-item" data-bs-toggle="modal" data-bs-target="#editCat" wire:click="edit('{{ $cliente -> id }}')">Editar</a></li>
                                          <li><a class="dropdown-item" onclick="confirm('¿Seguro que deseas eliminar este registro?') || event.stopImmediatePropagation()" wire:click="destroy('{{ $cliente -> id }}')">Eliminar</a></li>
                                        </ul>
                                    </div>
                                </td>
                            </tr>
            ...
            @else 
                ...
                <div class="py-5">
                    ...
                    <p class="text-center">No hay clientes aquí.</p>
                </div>
