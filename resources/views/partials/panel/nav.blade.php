<nav class="position-fixed top-0 h-100 d-sm-flex flex-column justify-content-between menu-nav p-4 p-sm-0">
	...
	<div class="d-flex justify-content-between align-items-center d-sm-none border-bottom pb-4 mb-4">
		<h3 class="d-block d-sm-none text-uppercase fw-700 m-0">Menú</h3>
	...
	<ul class="list-unstyled text-center navigation">
		...
		<li class="position-relative">
			<a href="#" class="d-sm-inline-block text-start d-block my-2 p-3 {{ request()->is('panel/eventos*') ? 'active' : '' }}">
				...
				<span class="text-dark py-sm-2 px-sm-3 rounded-3 text-nowrap">Mis eventos</span>
			</a>
		</li>
		<li class="position-relative">
			<a href="#" class="d-sm-inline-block text-start d-block my-2 p-3 {{ request()->is('panel/control-de-tickets*') ? 'active' : '' }}">
				...
				<span class="text-dark py-sm-2 px-sm-3 rounded-3 text-nowrap">Control de tickets</span>
			</a>
		</li>
		<li class="position-relative">
			<a href="#" class="d-sm-inline-block text-start d-block my-2 p-3 {{ request()->is('panel/finanzas*') ? 'active' : '' }}">
				...
				<span class="text-dark py-sm-2 px-sm-3 rounded-3 text-nowrap">Finanzas</span>
			</a>
		</li>
		<li class="position-relative">
			<a href="#" class="d-sm-inline-block text-start d-block my-2 p-3 {{ request()->is('panel/reventas') ? 'active' : '' }}">
				...
				<span class="text-dark py-sm-2 px-sm-3 rounded-3 text-nowrap">Mis ventas</span>
			</a>
		</li>
		<li class="position-relative">
			<a href="#" class="d-sm-inline-block text-start d-block my-2 p-3 {{ request()->is('panel/configuracion*') ? 'active' : '' }}">
				<img src="{{ asset('img/icos/ico-settings.svg') }}" width="24" height="24" class="me-2 me-sm-0">
				<span class="text-dark py-sm-2 px-sm-3 rounded-3 text-nowrap">Configuración</span>
			</a>
		</li>
	</ul>
